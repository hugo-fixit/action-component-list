...
> [`fnm`](https://github.com/Schniz/fnm), this template has a `.nvmrc` file at
> the root of the repository that can be used to automatically switch to the
> correct version when you `cd` into the repository. Additionally, this `.nvmrc`
